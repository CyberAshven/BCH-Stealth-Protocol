...
import { balanceChipHtml, infoBtn } from "../core/ui-helpers.js";
const id = "loan";
const title = "00 Loan";
const icon = "\u221E";
...
function _template() {
  return `<div class="dt-inner" style="padding:32px 40px">
    <div class="dt-page-header">
      <div class="dt-page-title-wrap"><div class="dt-page-icon"><img src="icons/loan.png" style="width:28px;height:28px"></div><div><div class="dt-page-title">Loan</div><div class="dt-page-sub">Moria Protocol \xB7 BCH Collateralized Lending</div></div></div>
    ...
    <div class="dt-pane active" id="dt-loan-p-borrow">
      ...
      <div style="text-align:center;font-size:11px;color:var(--dt-text-secondary);margin-top:8px">Powered by Moria Protocol \xB7 Open Source \xB7 Decentralized</div>
    </div>
...
function _calc() {
  ...
  if (!bch || !_bchPrice) {
    document.getElementById("dt-res-musd").textContent = "\u2014";
    return;
  }
...
function mount(container) {
  ...
  _unsubs.push(state.subscribe("prices", (p) => {
    ...
    if (el) el.textContent = "BCH $" + _bchPrice.toFixed(2);
    _calc();
  }));
}
function unmount() {
