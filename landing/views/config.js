...
const id = "config";
const title = "00 Settings";
const icon = "\u2699";
let _container = null, _unsubs = [];
function _ep(key, def) {
  return localStorage.getItem("00_ep_" + key) || def;
}
function _template() {
  return `<div class="dt-inner" style="padding:32px 40px">
    <div class="dt-page-header">
      <div class="dt-page-title-wrap"><div class="dt-page-icon">\u2699</div><div><div class="dt-page-title">Settings</div><div class="dt-page-sub">Endpoints \xB7 Network \xB7 Preferences</div></div></div>
    </div>
    <div class="dt-card">
...
function mount(container) {
  ...
  document.getElementById("cfg-save")?.addEventListener("click", () => {
    ...
    for (const [key, id2] of Object.entries(sets)) {
