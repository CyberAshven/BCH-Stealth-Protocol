...
function _template() {
  ...
  return `<div class="dt-inner" style="padding:32px 40px">
    <div class="dt-page-header">
      <div class="dt-page-title-wrap"><div class="dt-page-icon"><img src="icons/vault.png" style="width:28px;height:28px"></div><div><div class="dt-page-title">Vault</div><div class="dt-page-sub">Stealth Multisig \xB7 MuSig2</div></div></div>
    ...
    <div class="dt-pane active" id="dt-vault-p-vaults">
      <div id="dt-vault-list"><div class="dt-empty"><div class="dt-empty-icon">\u{1F510}</div><div class="dt-empty-text">No vaults yet</div><div style="font-size:12px;color:var(--dt-text-secondary);margin-top:8px">Create a multisig vault from the Create tab</div></div></div>
